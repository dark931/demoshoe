	...
	<div class="row clearfix" id="header-logo">
		...
		<div class='col-12 col-sm-12 col-md-6 col-lg-6 header-right'>
			<form class="search-box" method="get" id="searchform" role="search" action="{{ route('search') }}">
				<div class="form-input-search">
					<input type="text" name="key" placeholder="Nhập sp cần tìm kiếm rồi nhấn Enter" class="search-input">
